...
//        Listing all users in chat recycler
        ...
        connectChat.setOnClickListener(view -> {
            ...
            reference = database.getReference("users/chats/");
                ...
                ChatMessageLoader user = new ChatMessageLoader( imageURL,intent.getStringExtra("Profession"),"","", intent.getStringExtra("Name"),auth.getUid());
                            ...
                            ref.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    ...
                                    if (PATH.contains("Recruiter")){
                                        user2 = new ChatMessageLoader( userDetails.getImageURL(),"Recruiter","","", userDetails.getUserName(),seeker_id);
                                    }
                                    else {
                                        user2 = new ChatMessageLoader( userDetails.getImageURL(),intent.getStringExtra("Profession"),"","", userDetails.getUserName(), seeker_id);
                                    }
